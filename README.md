...
* **[Cloud Intelligent Travel Planner](https://github.com/AleLodetti/MultiAgentsSystem](https://github.com/AleLodetti/cloud_computing_public)**: A cloud-native travel orchestration system developed in C# utilizing the Semantic Kernel framework. The architecture implements Agent-to-Agent (A2A) communication and integrates the Model Context Protocol (MCP) to resolve complex, multi-step routing, planning, and scheduling tasks.
